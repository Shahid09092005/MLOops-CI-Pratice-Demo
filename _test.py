...
# Pytest automatically detects functions starting with test_.

# ✔ test_square() → checks square logic
# ✔ test_cube() → checks cube logic
# ✔ test_fifth_power() → checks power logic
